...
var file_proto_tag_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x3f, 0x0a, 0x03, 0x54, 0x61,
	...
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x22, 0x3d, 0x0a, 0x11, 0x47,
	...
	0x2f, 0x74, 0x61, 0x67, 0x73, 0x42, 0x0f, 0x5a, 0x0d, 0x2e, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
...
var file_proto_tag_proto_goTypes = []interface{}{
	(*Tag)(nil),               // 0: proto.Tag
	(*GetTagListRequest)(nil), // 1: proto.GetTagListRequest
	(*GetTagListReply)(nil),   // 2: proto.GetTagListReply
	(*Pager)(nil),             // 3: proto.Pager
}
var file_proto_tag_proto_depIdxs = []int32{
	0, // 0: proto.GetTagListReply.list:type_name -> proto.Tag
	3, // 1: proto.GetTagListReply.pager:type_name -> proto.Pager
	1, // 2: proto.TagService.GetTagList:input_type -> proto.GetTagListRequest
